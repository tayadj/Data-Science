...
T = 25
L = 0.01
classifier = p1.pegasos

train_accuracy, test_accuracy = \
	p1.classifier_accuracy(classifier,train_bow_features,test_bow_features,train_labels,test_labels,T=T,L=L)
print("{:50} {:.4f}".format("Training accuracy:", train_accuracy))
print("{:50} {:.4f}".format("Test accuracy:", test_accuracy))
...
best_theta, _ = classifier(train_bow_features,train_labels,T,L)
